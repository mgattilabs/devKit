---
name: review-bugs
description: "Checklist for detecting bugs, logic errors, edge cases, and security issues in a code diff. Use when reviewing code for correctness."
user-invocable: false
---

# Bug & Logic Review Checklist

Analyze the provided diff for defects, logic errors, and correctness issues. Read surrounding context as needed to understand control flow.
...
Return a bulleted list ordered by severity (Critical > High > Medium > Low):

```
- **[Severity] [File:Line]** `code snippet` — Description of the bug and suggested fix.
```

If no issues found: `No bugs or logic issues found.`
