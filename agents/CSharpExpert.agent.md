...
## Skills
Cerca nelle skills quella migliore per il compito. Se non sei sicuro, chiedi all'utente maggiori dettagli sul compito da svolgere.


## Review
When finishing coding use @simplifier to suggest improvements. Focus on readability, maintainability, and adherence to .NET conventions. Provide specific feedback and examples for any suggested changes.